...
/* The staging warning banner was removed for production readiness. The
   backend /api/environment endpoint and its environment detection are
   deliberately LEFT INTACT - only the visible banner is gone. */
